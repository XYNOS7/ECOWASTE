...
The user wants to modify the admin dashboard to handle database constraint violations properly and update the home screen to properly count reports from the database. Based on the given code and instructions, I am modifying the code to fetch total report counts from the database instead of the user profile, and adding real-time subscriptions to update report counts.
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Set total reports count from actual database data
